...
class MarsTest extends Specification {
    ...
    @Unroll
    "should move backwards by one to #direction"(Direction direction, int x, int y) {
        given:
        def rover = Mock(Rover)
        rover.getDirection() >> direction
    ...
    @Unroll
    "should move backwards by one to #direction with obstacles"(Direction direction, int x, int y) {
        given:
        def rover = Mock(Rover)
        rover.getDirection() >> direction
